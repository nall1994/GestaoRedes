...
public class MessageDispatcherImpl implements MessageDispatcher {
    ...
    private final Map<Class<? extends Address>, List<TransportMapping<? extends Address>>> transportMappings =
    ...
    public synchronized void addTransportMapping(TransportMapping transport) {
        List<TransportMapping> transports =
                transportMappings.computeIfAbsent(transport.getSupportedAddressClass(), k -> new LinkedList<>());
