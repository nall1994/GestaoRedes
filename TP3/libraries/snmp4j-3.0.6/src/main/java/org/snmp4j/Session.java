...
public interface Session extends Closeable {
     ...
     *         if the message could not be send.
     */
    void send(PDU pdu, Target target, Object userHandle, ResponseListener listener) throws IOException;
     ...
     *         if the message could not be send.
     */
    ResponseEvent send(PDU pdu, Target target, TransportMapping<?> transport) throws IOException;
     ...
     *         if the message could not be send.
     */
    void send(PDU pdu, Target target, TransportMapping<?> transport, Object userHandle,
