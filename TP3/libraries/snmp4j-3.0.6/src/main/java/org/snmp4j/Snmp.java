...
public class Snmp implements Session, CommandResponder {
     ...
     *
     * @return <code>true</code> if registration was successful and <code>false</code>
     ...
     *
     * @return <code>true</code> if the notification listener has been removed
     * successfully.
     */
     ...
     *         the listen address.
     *
     * @return the {@link TransportMapping} for the specified listen address or <code>null</code>
     ...
     *
     * @return a byte array containing the authoritative engine ID or <code>null</code>
     ...
     *
     * @return <code>true</code> if context engine ID discovery is disabled.
     * @since 2.0
     */
     ...
     *
     * @return a TimeoutModel instance (never <code>null</code>).
     ...
     *
     * @return the <code>ReportHandler</code> instance.
     * @since 1.6
     */
    ...
    protected class PendingRequest extends TimerTask implements PduHandleCallback<PDU>, Cloneable {
         ...
         * to <code>null</code>.
         *
         * @return <code>true</code> if cancellation was successful.
         */
