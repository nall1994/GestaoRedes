...
public class DTLSTMTest {
    ...
    private static final OctetString SERVER_FINGER_PRINT = new OctetString("1");
    ...
    public void setUp() throws Exception {
        ...
        dtlstmCR.setServerEnabled(true);
    ...
    public void sendMessage() throws Exception {
        ...
        CertifiedTarget certifiedTarget = new CertifiedTarget(dtlstmCR.getListenAddress(),
    ...
    public void sendMessageWithPDU() throws Exception {
        final boolean[] messageReceived = { false };
        CertifiedTarget certifiedTarget = new CertifiedTarget(new DtlsAddress(dtlstmCR.getListenAddress()),
                new OctetString(SEC_NAME), SERVER_FINGER_PRINT, CLIENT_FINGER_PRINT);
    ...
    public void sendNotifyV3DTLSTM() throws Exception {
        ...
        CertifiedTarget target = new CertifiedTarget(new DtlsAddress(dtlstmCR.getListenAddress()),
                new OctetString(SEC_NAME), SERVER_FINGER_PRINT, CLIENT_FINGER_PRINT);
